...
print(df_long.head())
df_long.to_csv('examples/MK-torque/r-o-a-threezone/torque-threezone-dfpositions.csv',index=False)


#plot movie
swrm.plot_all(movie_filename=f'examples/MK-torque/r-o-a-threezone/torque-threezone_6000iter.mp4', fps=100, fluid='quiver', plot_heading=True) # realtime #4 #min v0, max v0, r_r, r_o, r_a, dt, constant xflow, constant yflow, iter, frames